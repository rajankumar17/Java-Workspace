...
public class WaitNotifyTest {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        Runnable waitTask = new Runnable(){
            ...
            public void run(){
                try {
                    ...
                    Logger.getLogger(WaitNotifyTest.class.getName()).
                           log(Level.SEVERE, null, ex);
                }
                System.out.println(Thread.currentThread() + " finished Execution Wait");
            }
        };
        ...
        Runnable notifyTask = new Runnable(){
            ...
            public void run(){
                test.go();
                System.out.println(Thread.currentThread() + " finished Execution Notification");
            }
        };
