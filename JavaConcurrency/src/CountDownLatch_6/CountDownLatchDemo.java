...
/**
 * Java program requires 3 services namely CacheService, AlertService and
 * ValidationService to be started and ready before application can handle any
...
public class CountDownLatchDemo {
    ...
    public static void main(String args[]) {
        ...
        // count 3 and wait until count reaches zero. each thread once up and
        // read will
