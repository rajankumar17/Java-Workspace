...
class Processor extends Thread {
	...
	//in sone system if volatile is removed and the running value is cached by the thread
	//it will keep on running since it wont notice changing the value of running by main thread
